...
\srcfull{} (hereafter, \src{}) is a transient radio source \citep[][hereafter \citetalias{2024MNRAS.535..909D}]{2024MNRAS.535..909D} discovered in the Variables and Slow Transients (VAST) survey \citep{2013PASA...30....6M}.
...
For this reason, pulse ToAs are typically mapped to the rising edge of highly scattered pulses, which closely approximates the centre of the original unscattered pulse \citep[][and references therein]{2025arXiv250614519J}.
...
\begin{figure*}
    \centering
    \includegraphics[width=0.98\linewidth]{scattering_DM.pdf}
