...
We therefore identified the times of arrival (ToAs) with the $\mu$ parameter in the fits given in \Eqn~\ref{eqn:emg}, which represents the location of the assumed Gaussian pulse before scattering.
...
\begin{figure*}{th}
  ...
  \caption{Timing residuals (top panel) and other pulse properties derived from the fits of \Eqn~\ref{eqn:emg} to the individual light curves (lower two panels). \dots}
...
As noted in \citetalias{2024MNRAS.535..909D}, optical follow-up of \src{} is hampered by its proximity to the Galactic plane ($b = -0.12^\circ$) and the associated extinction.
...
\begin{figure*}{th}
    ...
    \caption{Duty cycle vs radio pulse period for various long period radio emitters \citep{deRuiter2025,2022Natur.601..526H,2023Natur.619..487H,2024NatAs...8.1159C,2005Natur.434...50H,deRuiter2025,Lee2025}. The duty cycles are derived from the reported pulse widths for LPTs, which are compared to the range of the fitted, unscattered pulse widths of \src{} at 10\% of the peak. AR\,Sco \citep{2016Natur.537..374M,2018A&A...611A..66S} and other sources without well-defined duty cycles or periods \citep[e.g.][and references therein]{2021ApJ...920...45W} are not included on this plot.}
...
Interestingly, systems with spin-orbital (or beat-orbital) resonances of, e.g., 2:1 or 3:1, would be indistinguishable from systems in 1:1 resonances if the only pulses that can be observed occur within a limited orbital phase range.
...
In a similar vein, systems in which the spin-orbit (or beat-orbit) ratios are \emph{close to} small-integer ratios, or, equivalently, systems in which precession of the WD is significant, will exhibit an extra beating effect in which an orbitally-induced intermittency is aliased to a much lower frequency.
...
Its period of ${\sim}1.16\,$hours is slightly shorter than the minimum known orbital period of optically confirmed polars, marking it as an interesting case study in the context of \citet{2025A&A...695L...8R}'s suggestion that `short'-LPTs and `long'-LPTs may correspond to different classes of cataclysmic variables.
