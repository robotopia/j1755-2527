...
\begin{figure*}
    ...
    \caption{The $1\sigma$ positional uncertainty of \src{} derived from the MeerKAT observation taken on MJD 60602 is shown as the green ellipses overlaid on the optical (z, i, r) Panoramic Survey Telescope and Rapid Response System \citep[PanSTARRS;][]{2010SPIE.7733E..0EK,2016arXiv161205560C} image (left panel), and the infrared (K, H, J) United Kingdom Infrared Telescope Deep Sky Survey \citep[UKIDSS;][]{2007MNRAS.379.1599L} image (right panel).}
