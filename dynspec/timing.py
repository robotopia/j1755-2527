...
def get_J1755_ephemeris():
    return {
        'PEPOCH': Time(59965.0377, scale='utc', format='mjd'),
        'period': 4186.332579477463 * u.s,
...
def emg_cdf(t, A, μ, σ, τ):
    ...
    #return gaussian_cdf(t, A, μ, σ) - 0.5*np.exp(arg2) * erfc(arg1)
    return gaussian_cdf(t, A, μ, σ) - 0.5*np.exp(arg2 - arg1**2) * erfcx(arg1)
